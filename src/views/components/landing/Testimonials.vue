      ...
      <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div class="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
          ...
          <p class="text-gray-700">
            “Catat transaksi jadi super cepat. Anggaran bulanan jadi lebih terkontrol dan hematnya
            terasa.”
          </p>
        </div>
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
          ...
          <p class="text-gray-700">
            “Laporannya jelas dan mudah dipahami. Saya jadi tahu ke mana uang paling banyak
            terpakai.”
          </p>
        </div>
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
          ...
          <p class="text-gray-700">
            “Sinkronisasi lintas perangkatnya mulus. Dari HP ke laptop, semua data langsung
            nyambung.”
          </p>
        </div>
      </div>
